...
const Technologies = () => {
    ...
    const paragraphs = useMemo(() => [
        `<span class="titleTransition">Langages de programmation :</span><br />
            Maîtrise des langages de programmation web tels que HTML, CSS, JavaScript.<br />
            Connaissance d'autres langages comme Python, Ruby, PHP, etc., selon les besoins du projet.`,
        `<span class="titleTransition">Frameworks et bibliothèques :</span><br />
            Utilisation de frameworks et de bibliothèques populaires tels que React, Angular, Vue.js pour le développement front-end.<br />
            Utilisation de frameworks back-end tels que Node.js, Ruby on Rails, Django, Laravel, etc.`,
        ...
        `<span class="titleTransition">Débogage et tests :</span><br />
            Compétences en débogage de code pour identifier et résoudre les problèmes.<br />
            Réalisation de tests unitaires, tests d'intégration et tests fonctionnels.`,
